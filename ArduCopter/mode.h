...
public:
    ...
    enum class Number : uint8_t {
        ...
        STABILIZE2 =   27,  // manual airframe angle with manual throttle 2(copy)
    };
...
class ModeStabilize2 : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::STABILIZE2; }
...
protected:
    ...
    const char *name4() const override { return "STAB2"; }
